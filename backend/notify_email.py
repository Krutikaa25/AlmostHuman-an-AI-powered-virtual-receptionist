...
def send_calendar_invite(employee_name: str, employee_email: str, organizer_name: str, meeting_date: str, meeting_time: str, purpose: str, organizer_email: str = None):
...
"""
    ...
    msg.add_attachment(ics_content.encode('utf-8'), maintype='text', subtype='calendar', params={'method': 'REQUEST'}, filename='invite.ics')
    ...
    try:
        ...
        server.quit()
        print(f"✅ Calendar Invite successfully sent to {employee_email}" +
